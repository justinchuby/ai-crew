...
| Biological System | TIDE Parallel | What It Validates |
|-------------------|--------------|-------------------|
| **TCP congestion control** | Overall 4-state model | Adaptive throughput management with fast escalation and smooth recovery |
