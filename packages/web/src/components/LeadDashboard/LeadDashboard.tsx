      ...
      <div className="w-56 border-r border-gray-700 flex flex-col shrink-0">
        <div className="px-3 py-2 border-b border-gray-700 flex items-center justify-between">
          ...
          <button
            ...
            className="cursor-pointer p-1 rounded hover:bg-gray-700 text-gray-400 hover:text-gray-200"
            title="New Project"
          >
        ...
        <div className="flex-1 overflow-y-auto">
          {leadAgents.length === 0 && inactiveProjects.length === 0 && !showNewProject && (
            <div className="p-4 text-center">
              ...
              <button
                onClick={() => setShowNewProject(true)}
                className="cursor-pointer text-xs bg-yellow-600 hover:bg-yellow-500 text-black px-3 py-1.5 rounded font-semibold"
              >
                Create Project
              </button>
            </div>
        ...
        {showNewProject ? null : (
          <div className="border-t border-gray-700 p-2">
            <button
              onClick={() => setShowNewProject(true)}
              className="cursor-pointer w-full flex items-center justify-center gap-1.5 text-sm text-yellow-400 hover:text-yellow-300 py-1.5 rounded hover:bg-gray-800 transition-colors"
            >
              <Plus className="w-4 h-4" />
              New Project
            </button>
          ...
          >
            ...
            <div className="flex justify-end gap-2 px-5 py-3 border-t border-gray-700">
              <button
                ...
                className="cursor-pointer px-4 py-2 text-sm text-gray-400 hover:text-gray-200 rounded-md hover:bg-gray-700 transition-colors"
              >
                Cancel
              </button>
              <button
                        ...
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <div className="flex gap-1.5 shrink-0">
                            <button
                              ...
                              className="cursor-pointer p-1.5 rounded bg-green-800 hover:bg-green-700 text-green-200 transition-colors"
                              title="Confirm"
                            >
                            ...
                            <button
                              ...
                              className="cursor-pointer p-1.5 rounded bg-red-800 hover:bg-red-700 text-red-200 transition-colors"
                              title="Reject"
                            >
          ...
          {sidebarCollapsed ? (
            <div className="border-l border-gray-700 flex flex-col items-center py-2 w-10 shrink-0">
              <button
                ...
                className="cursor-pointer p-1.5 rounded hover:bg-gray-700 text-gray-400 hover:text-gray-200 relative"
                  ...
                  {d.needsConfirmation && d.status === 'recorded' && (
                    <div className="cursor-pointer flex gap-2 mt-2" onClick={(e) => e.stopPropagation()}>
                      ...
                      <button
                        ...
                        className="cursor-pointer text-xs px-2 py-1 rounded bg-red-800 hover:bg-red-700 text-red-200 flex items-center gap-1"
                      >
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  {onOpenChat && (
                    <button
                      ...
                      className="cursor-pointer text-xs leading-none text-blue-400 hover:text-blue-300 shrink-0 px-0.5"
          ...
          >
            ...
            <div className="flex items-center gap-3 px-5 py-4 border-b border-gray-700">
              ...
              <button
                ...
                className="cursor-pointer text-gray-400 hover:text-white text-lg leading-none p-1"
              >
                ×
              </button>
            </div>
            ...
            <div className="flex items-center justify-between px-4 py-3 border-b border-gray-700">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="cursor-pointer text-gray-400 hover:text-white text-lg leading-none"
                >
                  ×
                </button>
              </div>
  ...
  return (
    <div className="border-t border-gray-700 flex flex-col shrink-0" style={collapsed ? undefined : { height }}>
      <button
        ...
        className="cursor-pointer px-3 py-1.5 flex items-center gap-2 shrink-0 hover:bg-gray-800/50 transition-colors w-full text-left"
      >
      ...
      {editing ? (
        ...
        <>
          ...
          <button
            ...
            className="cursor-pointer text-gray-500 hover:text-yellow-400 text-[10px] shrink-0"
          >
            edit
          </button>
        </>
...
function PromptNav({ containerRef, messages }: { containerRef: React.RefObject<HTMLDivElement | null>; messages: AcpTextChunk[] }) {
  ...
  return (
    <div className="absolute right-3 top-3 flex flex-col items-center gap-0.5 z-10">
      <button
        onClick={goUp}
        className="cursor-pointer p-1 rounded bg-gray-800/80 border border-gray-700 text-gray-400 hover:text-white hover:bg-gray-700 transition-colors"
